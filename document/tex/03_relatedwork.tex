...
\begin{minipage}{\linewidth}
	\captionof{table}{Stromverbrauch der ausgeschalteten zusätzlichen Komponenten am TI CC2650STK}
...
\begin{minipage}{\linewidth}
	\captionof{table}{Stromverbrauch der ausgeschalteten zusätzlichen Komponenten am aconno ACNSENSA}
...
\begin{minipage}{\linewidth}
	\captionof{table}{Stromverbrauch der ausgeschalteten zusätzlichen Komponenten am Arduino Primo Core}
