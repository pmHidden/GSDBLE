...
% spi buffer im easydma kann maximal 255 bytes lesen in einer transaction wegen 8bit buffer -> in mehrere transactions aufsplitten ODER manuell im sdk ändern. funktioniert aber ist gegen hardwarespezifikation ODER nRF52840 Chip für 16-bit buffer
