...
\newcommand{\komTitle}{Implementierung und Evaluation eines Langstrecken-Funkkanals für Drohnen\xspace} 
...
\newcommand{\komSubmissionDate}{01. Januar 1990\xspace}% use only this date format
...
\begin{document}
	...
	\input{tex/03_relatedwork}
	\input{tex/04_design}
	\input{tex/05_implementation}
	\input{tex/06_evaluation}
